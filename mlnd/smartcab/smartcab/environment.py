...
class Environment(object):
    ...
    def sense(self, agent):
        ...
        for other_agent, other_state in self.agent_states.iteritems():
            ...
            elif other_state['heading'][0] == heading[1] and -heading[0] == other_state['heading'][1]:
...
class DummyAgent(Agent):
    ...
    def update(self):
        ...
        if self.next_waypoint == 'right' and inputs['light'] == 'red' and inputs['left'] == 'forward':
                action_okay = False
        elif self.next_waypoint == 'forward' and inputs['light'] == 'red':
                action_okay = False
        elif self.next_waypoint == 'left' and inputs['light'] == 'red' or (inputs['oncoming'] == 'forward' or inputs['oncoming'] == 'right'):
                action_okay = False
