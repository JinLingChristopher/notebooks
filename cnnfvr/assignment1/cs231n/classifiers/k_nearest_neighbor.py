...
class KNearestNeighbor(object):
    ...
    """
        ...
        #########################################################################
        testSum = np.sum(X ** 2, axis=1)
        trainSum = np.sum(self.X_train ** 2, axis=1)
        crossSum = np.dot(X, self.X_train.T)
        dists = np.sqrt(np.reshape(testSum, (-1, 1)) + trainSum - 2 * crossSum)
        #########################################################################
        #                         END OF YOUR CODE                              #
        #########################################################################
        return dists
